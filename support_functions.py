# -*- coding: utf-8 -*-
"""
Created on Wed Nov 11 16:03:12 2020
...
def calculate_accuracy(predicted_classes, actual_classes):
  # predicted and actual should have corresponding rows
  # return np.sum(np.where(predicted == actual, 1, 0))/predicted.shape[0]
  # return sum(predicted == actual)/predicted.shape[0]
